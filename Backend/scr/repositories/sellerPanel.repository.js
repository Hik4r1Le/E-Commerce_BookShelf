...
export const findManySellerOrder = async (filter, option, orderBy, skip, take) =>
    await prisma.order.findMany(queryBuilder(filter, option, null, orderBy, skip, take));

export const updateSellerOrder = async (filter, data) =>
